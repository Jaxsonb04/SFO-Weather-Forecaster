...
def main():
    ...
    # null comparisons require IS NULL / IS NOT NULL, not =
    ...
    # SUM(CASE WHEN ... THEN 1 ELSE 0 END) is a conditional count
    ...
    # ROW_NUMBER() OVER (PARTITION BY ... ORDER BY ...) is the top-N-per-group pattern
    ...
    # LAG(col, n) gives the value from n rows back in the window
    ...
    # AVG(CASE WHEN ... THEN col END) pivots rows into columns
    ...
    # HAVING excludes years with insufficient data -- always gate on data sufficiency
